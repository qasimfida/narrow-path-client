          ...
          {arr.map((item, i) => {
            return (
              <Drawer
                ...
                label={item.name}
                checkBoxClass={classes.checkBoxBtn}
              />
            );
          })}
          <Button className={classes.addBtn}>+ Add Another Bucket</Button>
          <Button className={classes.deleteBtn} >Delete Bucket </Button>
        </GridItem>
        <GridItem xs={12} md={8}>
          <div className={classes.wrapper}>
            ...
            <Button className={classes.saveBtn}>CREATE TRIP</Button>
          </div>
        </GridItem>
      </GridContainer>
    </div>
